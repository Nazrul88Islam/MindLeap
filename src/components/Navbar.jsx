...
const Navbar = () => {
  ...
  return (
    <header className="bg-heroBg text-white py-6 fixed top-0 left-0 right-0 z-10">
      <div className=" container mx-auto flex justify-between items-center h-full">
        ...
        <div className="hidden md:block">
          <a
            ...
            href="#contact"
            className="text-white bg-primary hover:
          bg-primary/90 px-4 py-2 rounded"
          >
            Contact Us
          </a>
        </div>
        ...
        <div className="block md:hidden">
          ...
          >
            <RiMenuFold3Fill className="size-6" />
          </button>
        </div>
      </div>
