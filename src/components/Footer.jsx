      ...
      <div className=" container mx-auto grid grid-cols-1 md:grid-cols-4 sm:grid-cols-2">
        <div className="space-y-6 mr-14">
          ...
          <p className=" text-para">
            ...
            unde laboriosam molestias nobis voluptate nulla distinctio et atque
            iste maiores ea illum commodi, rem fugit illo voluptatibus.
            Voluptates, aperiam consequuntur.
          </p>
        ...
        <div className="space-y-6 ">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-center gap-2">
              ...
              <p className="text-gray-700"> +880 24564545</p>
            </li>
