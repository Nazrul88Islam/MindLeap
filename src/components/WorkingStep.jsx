      ...
      >
        <div className=" text-white text-center mb-20">
          ...
          <p className="text-lg md:w-1/2 w-full mx-auto">
            ...
            incidunt similique est nam, eum aliqu id dignissimos, rerum,
            excepturi repellat sequi perspiciatis error cum voluptas atque
            maiores in alias neque nostrum!
          </p>
        </div>
        ...
        <div className="flex flex-col md:w-4/5 mx-auto md:flex-row gap-8 ">
          <div className="relative bg-white text-center rounded-lg p-6 flex-1">
            ...
            bg-primary text-white size-14 rounded-full flex items-center justify-center
             "
            >
              1
            </div>
            ...
            <p className="">
              Step 1 description goes here. loren ipsum dolar . fdsfdsfm
              jfgkdhgjkfdg
            </p>
          </div>
          ...
          <div className="relative bg-white text-center rounded-lg p-6 flex-1">
            ...
            <p className="">
              Step 2 description goes here. loren ipsum dolar . fdsfdsfm
              jfgkdhgjkfdg
            </p>
          </div>
          ...
          <div className="relative bg-white text-center rounded-lg p-6 flex-1">
            ...
            <h3 className="text-lg font-medium mt-8">Set Sechedule</h3>
            <p className="">
              Step 3 description goes here. loren ipsum dolar . fdsfdsfm
              jfgkdhgjkfdg
            </p>
          </div>
        </div>
